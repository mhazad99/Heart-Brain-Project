function [sleepStages] = ReadStagingFile(stagingFileName)
%READSTAGINGFILE 
%
% Example: ReadStagingFile('C:\imhr\HRV_pipeline\Data\MAPSedf\MP_015\MP_015_PSG2-Events.txt')
...
end % End of ReadStagingFile function
