...
for iter = 1:length(bounderies)/2
    ...
    for item = 1:N
        ...
        WindowPhaseStorage(:, item) = ShiftedPhase;
        % plot(WindowPhase)
    end
    for item = 1:N
    ...
    for Numberofepochs = 1:N
        ...
        SImbStorage(iter, Numberofepochs) = SIm;
        SIpbStorage(iter, Numberofepochs) = SIp;
        SI = 0;
    end
end
toc
% save SImbStorage SImbStorage
% save SIpbStorage SIpbStorage
figure
