...
if flag
    ...
    Path = 'C:\Users\AS79560\OneDrive - ETS\Thesis\Datasets\CPSDCoherences\SleepStagesBased\Sleep stages Avg Coherences';
    O1NREMAvgCon = AverageCont;
    O1NREMAvgDep = AverageDep;
    fileName1 = 'O1NREMAvgCon.mat';
    fullFilePath1 = fullfile(Path, fileName1);
    fileName2 = 'O1NREMAvgDep.mat';
    fullFilePath2 = fullfile(Path, fileName2);
    save(fullFilePath1, 'O1NREMAvgCon')
    save(fullFilePath2, 'O1NREMAvgDep')
    %%%
    %Diff = abs(Diff);
